...
{
    public class ShareControllerManager : IShareControllerManager
    {
        private readonly UserManager<AppUser> _userManager;
        private readonly SignInManager<AppUser> _signInManager;
        private readonly ILogger<ShareControllerManager> _logger;
        private readonly IConfiguration _configuration;
        private readonly IMapper _mapper;

        public ShareControllerManager
            (
                UserManager<AppUser> userManager,
                SignInManager<AppUser> signInManager,
                IMapper mapper,
                ILogger<ShareControllerManager> logger,
        ...
        private async Task<AuthResult> GenerateTokenAsync(AppUser appUser)
        {
            ...
            return new AuthResult()
            {
                ...
                StockName = appUser.StockName,
                Amount = securityToken.ToString,
                PricePerStock = handler.WriteToken(securityToken)
            };
        }
